...
#Label com a imagem de um cifrão
        self.label_cifrao = tk.Label(self.loja, text = '$', font ='Arial',bg = 'pink')
        self.label_cifrao.grid(row=0, column=0)
        
#Label da contagem das moedas
        self.label_moeda = tk.Label(self.loja, text = self.compras.cofre, bg = 'pink')
...
#Label para ajustar os espaçamentos dos botões
        self.label_ajuste1 = tk.Label(self.loja, text = '', bg = 'pink')
        self.label_ajuste1.grid(row=1, column=0, columnspan=3)
        
        self.label_preco1 = tk.Label(self.loja, text = self.compras.preco, bg = 'pink')
        self.label_preco1.grid(row=3, column=0, columnspan=1 )
        
        self.label_preco2 = tk.Label(self.loja, text = self.compras.preco, bg = 'pink')
        self.label_preco2.grid(row=3, column=2, columnspan=1 )
        
        self.label_preco3 = tk.Label(self.loja, text = self.compras.preco, bg = 'pink')
        self.label_preco3.grid(row=5, column=0, columnspan=1 )
        
        self.label_preco4 = tk.Label(self.loja, text = self.compras.preco, bg = 'pink')
